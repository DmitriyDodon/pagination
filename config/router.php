...
$router->get('/category/{id}/delete', '\App\Controller\CategoryController@delete');
...
$router->get('/post/{id}/delete', '\App\Controller\PostController@delete');
...
$router->get('/tag/{id}/delete', '\App\Controller\TagController@delete');